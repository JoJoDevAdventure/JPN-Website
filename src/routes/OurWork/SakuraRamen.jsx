      ...
      <div className="w-full">
        ...
        <div className="mx-4 md:mx-[150px] mt-12">
          ...
          <div className="flex flex-col-reverse md:flex-row mb-12 gap-10 items-center">
            ...
            <div className="md:w-2/3 w-full">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#0D7685] mb-4">Event Participation</h2>
              <p className="text-base md:text-xl mb-6">
          ...
          <div className="flex flex-col-reverse md:flex-row mb-12 gap-10 items-center">
            <div className="md:w-2/3 w-full">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#0D7685] mb-4">Eye-catching New Menu Items</h2>
              <p className="text-base md:text-xl mb-6">
          ...
          <div className="flex flex-col-reverse md:flex-row mb-12 gap-10 items-center">
            ...
            <div className="md:w-2/3 w-full">
              <h2 className="text-2xl md:text-3xl font-semibold text-[#0D7685] mb-4">Gacha Machine Installation</h2>
              <p className="text-base md:text-xl mb-6">
